...
(function() {
    ...
    angular.module('ionic.contrib.drawer', ['ionic'])
        ...
        .controller('drawerCtrl', ['$rootScope', '$scope', '$element', '$attrs', '$ionicGesture', '$ionicBody', '$document',
            function($rootScope, $scope, $element, $attrs, $ionicGesture, $ionicBody, $document) {
            ...
            side = $attrs.side == 'left' ? LEFT : RIGHT;
        ...
        // .directive('menuAndDrawerToggle', ['$rootScope', function($rootScope) {
        //     return {
        //         restrict: 'AC',
        //         require: '^drawer',
        //         link: function($scope, $element, $attrs, ctrl) {
